  ...
  useEffect(() => {
    ...
    const handleConnect = (event: AppKitStateEvent) => {
      ...
      if (isUserInitiated) {
        ...
        console.log("Ignoring automatic connection attempt")
      }
    }
    ...
    try {
      ...
      // This was causing automatic Phantom connection
      // Users should manually choose their wallet via the connect modal
    } catch (error) {
      console.error("Failed to subscribe to AppKit events:", error)
      // No fallback connection attempts - let user choose manually
    }
